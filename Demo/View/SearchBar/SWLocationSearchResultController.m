//
//  SWLocationSearchResultController.m
//  SWChatUI
//
...
@interface SWLocationSearchResultController ()
...
@interface SWLocationSearchResultController () <UITableViewDataSource, UITableViewDelegate, AMapSearchDelegate>
...
@implementation SWLocationSearchResultController {
    NSInteger curPage;
...
- (void)viewDidLoad {
    ...
    CALayer *line1 = [SWChatManage lineWithLength:SCREEN_WIDTH atPoint:CGPointZero];
    line1.backgroundColor = UIColor.darkGrayColor.CGColor;
    ...
    request.types   = allPOISearchTypes;
...
- (void)setupFooterView {
    ...
    CALayer *line2 = [SWChatManage lineWithLength:SCREEN_WIDTH atPoint:CGPointMake(0, CGRectGetHeight(_footerView.frame)-0.5)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        cell = [[SWLocationTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    SWLocationTableViewCell *cell = (SWLocationTableViewCell *)[tableView cellForRowAtIndexPath:indexPath];
